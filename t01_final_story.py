...
delay = 0.5          # change to 0.0 for testing/speed runs; larger for dramatic effect!
dead = False
...
def team_1_adv():
    ...
    if chest == "1":
        ...
        # good choice
        print("I like your moxie,", username, "!\n"
        ...
        print("Yay, you got treasure! I hope it doesn't slow you down!")
        sleep(delay / 2)
...
def team_3_adv():
    ...
    print()
    print("In front of you are three different choices for weapons to fight the knight with")
    sleep(delay * 2)
    print("1.Sword")
    print("2.Crossbow")
    print("3.Spear")
...
def team_5_adv():
    ...
    if choice == "Free her":
        ...
        if choice2 == "Jump forward":
            sleep(delay)
            print(
                "Oh NO. You fall into a pond full of hungry alligators who devour you into pieces once you reach the bottom.")
            dead = True
        else:
...
def team_6_adv():
    action = input(
        "You can (1) seek light in the cave, (2) become familiar with the cave, (3) make a fire with rocks, or (4) wait for help] \n Type your number choice: ")
    if action == "4":
        # bad choice
        ...
        # good choice
        print(
            "luckily, you're able to find a light. Now, you are presented with a new challenge. \n You must find rescue a woman and her children from a goblin guarded tower. \n")
    else:
        # neutral
...
def team_8_adv():
    ...
    print()
    print(
        "You are now in a marketplace. An old man comes up, claiming he has magical pills that could bring you fortune.")
